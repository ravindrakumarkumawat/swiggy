...
const Home = () => {
  return (
    <>
      ...
      <div className="flex">
        <div className="bg-white border-2 w-64 h-4/6 shadow-md mx-12 py-7 cursor-pointer sticky top-0">
            ...
            <div className="grid grid-cols-3 py-12 gap-8">
              <div className="w-72 bg-white cursor-pointer border-2 border-white hover:border-gray-200 hover:shadow-md p-3.5">
                ...
                <div className="my-3">
                  ...
                  <div className="text-gray-500 font-md text-xs">North Indian, Desserts, Biryani</div>
                </div>
